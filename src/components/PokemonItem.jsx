...
const PokemonItem = ({ pokemon }) => {
  ...
  return (
    <>
      <div className="w-64 h-72 border border-gray-300 rounded-lg shadow-md flex flex-col items-center justify-between cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gray-500/50" onClick={handleCardClick}>
        {/* Imagem do Pokémon */}
      ...
      {isModalOpen && <PokemonDetail pokemon={pokemon} handleCardClick={handleCloseModal} />}
    </>
  );
};
